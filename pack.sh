...
python script_tool.py write -i raw/DATA1/script -o build/DATA1/script -c script.csv -g build/glyph_table.csv

python gen_glyph_images.py -i build/glyph_table.csv -f assets/NotoSansCJKsc-Medium.otf --font-size 16 --offset-y -1 -o build/font_16_a0.png
